          ...
          <div class="row">
              <div class="col-md-4">
                  <div class="car-wrap rounded ftco-animate">
                      ...
                      <div class="text">
                          <h2 class="mb-0"><a href="/cars-single">Mercedes Grand Sedan</a></h2>
                          <div class="d-flex mb-3">
                              <span class="cat">Cheverolet</span>
                              <p class="price ml-auto">$500 <span>/day</span></p>
                          </div>
                          <p class="d-flex mb-0 d-block"><a href="#" class="btn btn-primary py-2 mr-1">Book now</a> <a href="/cars-single" class="btn btn-secondary py-2 ml-1">Details</a></p>
                      </div>
                  </div>
              </div>
              <div class="col-md-4">
                  <div class="car-wrap rounded ftco-animate">
                      ...
                      <div class="text">
                          <h2 class="mb-0"><a href="/cars-single">Range Rover</a></h2>
                          <div class="d-flex mb-3">
